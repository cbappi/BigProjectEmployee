...
Route::get('/companyPage',[CompanyController::class,'CompanyPage'])->middleware([TokenVerificationMiddleware::class]);
...
Route::get("/list-employee",[EmployeeController::class,'EmployeeList'])->middleware([TokenVerificationMiddleware::class]);

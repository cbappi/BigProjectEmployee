            ...
            <div class="col-12">
                <div class="tab-style1">
                    ...
                    <ul class="nav nav-tabs justify-content-center" role="tablist">
                        <li class="nav-item">
                                <a class="nav-link active" id="arrival-tab" data-bs-toggle="tab" href="#Top" role="tab" aria-controls="arrival" aria-selected="true">Top</a>
                        </li>
...
Top();
async function Top(){
    let res=await axios.get("/ListJobByRemark/top");
    $("#TopItem").empty();
                            ...
                            <div class="product">
                                ...
                                <div class="product_info">
                                    ...
                                    <div class="product_price">
                                        <span class="price">$ ${item['salary']}</span>
                                    </div>
...
async function New(){
    let res=await axios.get("/ListJobByRema/new");
    $("#NewItem").empty();
    res.data['data'].forEach((item,i)=>{
        let EachItem=`<div class="col-lg-3 col-md-4 col-6">
                            <div class="product">
...
async function Special(){
    let res=await axios.get("/ListJobByRemark/special");
    $("#SpecialItem").empty();
...
async function Trending(){
    let res=await axios.get("/ListJobByRemark/trending");
    $("#TrendingItem").empty();
    res.data['data'].forEach((item,i)=>{
        let EachItem=`<div class="col-lg-3 col-md-4 col-6">
                            <div class="product">
